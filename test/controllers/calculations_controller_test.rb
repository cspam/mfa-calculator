...
class CalculationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculation" do
    assert_difference('Calculation.count') do
      post calculations_url, params: { calculation: { annual_income: @calculation.annual_income, capital_gains: @calculation.capital_gains, deduction: @calculation.deduction, dependent_children: @calculation.dependent_children } }
    end
  ...
  test "should update calculation" do
    patch calculation_url(@calculation), params: { calculation: { annual_income: @calculation.annual_income, capital_gains: @calculation.capital_gains, deduction: @calculation.deduction, dependent_children: @calculation.dependent_children } }
